                        ...
                        <div class="relative inline-block px-6">
                            ...
                            <div id="myDropdown" class="dropdownlist absolute bg-gray-800 text-white right-0 mt-3 py-3 pr-8 overflow-auto z-30 invisible">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf                                    
                                    <a href="{{ route('logout') }}" onclick="event.preventDefault();this.closest('form').submit();" class="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i class="fas fa-sign-out-alt fa-fw"></i> Log Out</a>
                                </form>
